...
console.log(validateMasterCard("5201345267329843"));  //pattern 1
console.log(validateMasterCard("2221 0012 3456 7890"))   //pattern 2
console.log(validateMasterCard("2720998765432109"))   //pattern 3
console.log(validateMasterCard("'1001 3452 6732 9843'"))   //none
...
// the second pattern: starts with 22 which ensures that the string must start with it and then followed by a range of 2-9 and  then 13 more digits from 1-9 to make a total of 16 digits.

// the third pattern: this has the first digit of 2 ensuring that the string must start with  it and then a range of 3-7 for the second digit, followed by a range of 0-2 for the third digit and then 13 more digits to sum 16.
